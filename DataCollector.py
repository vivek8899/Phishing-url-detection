...
dat1 = create_structured_data(collection_list)
...
df = pd.DataFrame(data=dat1, columns=columns)

# # labelling
df['label'] = 0

df.to_csv("structured_data_legitmate.csv", mode ="a" , index = False) # header shpuld be false after the first run